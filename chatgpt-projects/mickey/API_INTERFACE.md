...
- Bridge/orchestrator continuity tools may call `checkpoint_thread`; durable memory uses the lifecycle-v1 begin/commit/flush contract rather than project-local append actions.
