...
- browser/computer-use foundation: `list_browser_profiles`, `browser_status`, `list_browser_tabs`, `browser_tab_info`, `open_browser_tab`, `activate_browser_tab`, `close_browser_tab`, `computer_status`, `observe_screen`
