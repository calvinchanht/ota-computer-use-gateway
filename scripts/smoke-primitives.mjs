...
async function seedWorkspace(rootDir) {
  ...
  await writeFile(path.join(rootDir, '.agent/MICKEY_PROVIDER_ACCEPTANCE.md'), 'Smoke provider acceptance checklist.\n');
...
async function exerciseContext(port, sessionId) {
  ...
  await expectText(port, sessionId, 'get_agent_bootstrap', { workspace_id: 'smoke' }, 'provider_acceptance');
