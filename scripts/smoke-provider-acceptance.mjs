...
async function expectToolSurface(sessionId) {
  const registeredRuntimeTools = ['browser_cdp_browser_call', 'browser_cdp_call', 'run_command', 'start_process', 'memory_begin_turn', 'memory_commit_turn', 'memory_flush_session', 'get_project_context', 'list_artifacts'];
  const policyRuntimeTools = ['run_command', 'start_process', 'memory_begin_turn', 'memory_commit_turn', 'memory_flush_session', 'get_project_context', 'list_artifacts'];
