...
function allowedTools(workspace: Workspace): string[] {
  ...
  if (workspace.allow_read) base.push('list_dir', 'stat_path', 'tree', 'read_file', 'search_files', 'git_status', 'git_diff', 'get_context_snapshot', 'get_agent_bootstrap');
  if (workspace.allow_write) base.push('write_file', 'edit_file', 'record_progress', 'record_decision', 'record_handoff', 'update_current_task', 'checkpoint_thread');
