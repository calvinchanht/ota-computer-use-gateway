...
function allowedTools(workspace: Workspace): string[] {
  ...
  if (workspace.allow_read) base.push('list_dir', 'stat_path', 'tree', 'read_file', 'read_binary_file', 'search_files', 'git_status', 'git_diff', 'get_context_snapshot', 'get_agent_bootstrap');
