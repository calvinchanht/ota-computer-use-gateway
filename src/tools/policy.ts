...
function allowedTools(workspace: Workspace): string[] {
  ...
  if (workspace.allow_mouse_keyboard) base.push('browser_manage_tabs', 'browser_click_and_wait', 'browser_cdp_browser_call', 'browser_cdp_browser_batch', 'browser_cdp_call', 'browser_cdp_batch');
  return base;
}
