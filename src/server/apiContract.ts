...
const CONTRACTS: Record<string, ContractSpec> = {
  ...
  windows_screenshot: spec({ workspace_id: 'string required', monitor: 'string optional', visual_followup: 'object optional; may include job_id or agent_id', job_id: 'string optional', threaddex_job_id: 'string optional' }),
  windows_window_screenshot: spec({ workspace_id: 'string required', hwnd: 'integer required', visual_followup: 'object optional; may include job_id or agent_id', job_id: 'string optional', threaddex_job_id: 'string optional' }),
  windows_window_screenshot_sequence: spec({ workspace_id: 'string required', hwnd: 'integer required', interval_ms: 'integer optional; >=50; requested span <=5000ms', count: 'integer optional; 2..8; default 8', visual_followup: 'object optional; may include job_id or agent_id', job_id: 'string optional', threaddex_job_id: 'string optional' }),
