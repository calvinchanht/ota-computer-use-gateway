...
const CONTRACTS: Record<string, ContractSpec> = {
  ...
  windows_window_screenshot: spec({ workspace_id: 'string required', hwnd: 'integer required', visual_followup: 'object optional; may include job_id or agent_id', job_id: 'string optional', threaddex_job_id: 'string optional', threaddex_base_url: 'string optional' }),
