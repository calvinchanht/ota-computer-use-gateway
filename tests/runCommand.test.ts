...
import { runConfiguredCommand } from '../src/tools/runCommand.js';
...
async function fixtureWorkspace(allowTests: boolean): Promise<Workspace> {
  ...
  return { id: 'test', name: 'Test', root, realRoot: root, allow_read: true, allow_patch: false, allow_tests: allowTests, allow_screen: false, allow_mouse_keyboard: false, commands: { echo: 'printf hello' } };
}
