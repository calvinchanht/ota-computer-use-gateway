...
const config: AppConfig = {
  ...
  workspaces: [{ id: 'secret-id', name: 'Secret', root: '/secret/path', allow_read: true, allow_write: false, allow_patch: false, allow_tests: false, allow_screen: false, allow_mouse_keyboard: false, browser: { profiles: [] }, commands: {}, filesystem: { machine_admin_host_scope: false, host_root: '/' } }],
  security: { max_file_bytes: 1000, max_response_bytes: 1000, max_request_bytes: 12345, max_search_results: 10, max_exec_ms: 120000 }
};
