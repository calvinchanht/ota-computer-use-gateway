...
const config: AppConfig = {
  server: { host: '127.0.0.1', port: 8765, rate_limit: { enabled: true, window_ms: 60000, max_requests: 120, trust_proxy_headers: false }, auth: { enabled: true, bearer_token_env: 'TEST_BEARER', allow_loopback_without_auth: false } },
  workspaces: [],
